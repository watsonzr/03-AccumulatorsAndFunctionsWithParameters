...
def draw_circles1():
    ...
    cent = rg.Point(200, 200)
    for i in range(21):
        c = rg.Circle(cent, 10 * i)
        c.attach_to(window)
        window.render()
...
def draw_circles2():
    ...
    for i in range(18):
        circle = rg.Circle(rg.Point((20 * i) + 50, 100), 10)
...
def print_cosines():
    ...
    print 80 times the cosine of that integer.
...
def draw_cosines_and_sines():
    ...
    for i in range(101):
        circle = rg.Circle(rg.Point(200 + (80 * math.cos(i)), 200 + (80 * math.sin(i))), 10)
        circle.attach_to(window)
        window.render()
